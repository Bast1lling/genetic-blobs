...
pub fn draw_coordinate_system(app: &App, model: &Model, draw: &Draw, window: &Ref<Window>){
    ...
    //cross-hair
    draw_crosshair(&draw, &win, model.center);
...
fn draw_crosshair(draw: &Draw, win: &Rect, start: Vec2){
